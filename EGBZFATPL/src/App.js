...
function App() {   //constants go here
  ...
  { name: "Deer", cr: "0", terrain: "arctic", faction: "Calanthian Frozen North" },
  { name: "Crawling hand", cr: "0", terrain: "arctic", faction: "Dungeon" },
  { name: "Rat", cr: "0", terrain: "arctic", faction: "Dungeon" },
  { name: "Bat", cr: "0", terrain: "arctic", faction: "Dungeon" },
  { name: "Lemure", cr: "0", terrain: "arctic", faction: "Dungeon" },
  { name: "Homunculus", cr: "0", terrain: "arctic", faction: "Dungeon" },
  { name: "Juvenile Mimic", cr: "0", terrain: "arctic", faction: "Dungeon" },
  { name: "Dowar", cr: "0", terrain: "arctic", faction: "Dungeon" },
  { name: "Spider", cr: "0", terrain: "arctic", faction: "Dungeon" },
  { name: "Myconid Sprout", cr: "0", terrain: "arctic", faction: "Dungeon" },
    ...
    "1/8": [
      ...
      { name: "Ice Snake", cr: "1/8", terrain: "arctic", faction: "Calanthian Frozen North" },
      { name: "Twig Blight", cr: "1/8", terrain: "arctic", faction: "Dungeon" },  
      { name: "Gremishka", cr: "1/8", terrain: "arctic", faction: "Dungeon" }, 
      { name: "Xvart", cr: "1/8", terrain: "arctic", faction: "Dungeon" }, 
      { name: "Kobold", cr: "1/8", terrain: "arctic", faction: "Dungeon" },
      { name: "Tribal Warrior", cr: "1/8", terrain: "arctic", faction: "Dungeon" }, 
      { name: "Manes", cr: "1/8", terrain: "arctic", faction: "Dungeon" }, 
      { name: "Boggle", cr: "1/8", terrain: "arctic", faction: "Dungeon" },  
      { name: "Vox Seeker", cr: "1/8", terrain: "arctic", faction: "Dungeon" },
      { name: "Boggle", cr: "1/8", terrain: "arctic", faction: "Dungeon" },
      { name: "Stirge", cr: "1/8", terrain: "arctic", faction: "Dungeon" },
      { name: "Giant Rat", cr: "1/8", terrain: "arctic", faction: "Dungeon" },
      { name: "Poisonous Snake", cr: "1/8", terrain: "arctic", faction: "Dungeon" },
      { name: "Neogi Hatchling", cr: "1/8", terrain: "arctic", faction: "Dungeon" },
    ],
    "1/4": [
      ...
      { name: "Grimlock", cr: "1/4", terrain: "arctic", faction: "Dungeon" },
      { name: "Dretch", cr: "1/4", terrain: "arctic", faction: "Dungeon" },
      { name: "Giant Wolfspider", cr: "1/4", terrain: "arctic", faction: "Dungeon" },
      { name: "Wretched Sorrowsworn", cr: "1/4", terrain: "arctic", faction: "Dungeon" },
      { name: "Troglodyte", cr: "1/4", terrain: "arctic", faction: "Dungeon" },
      { name: "Flying Sword", cr: "1/4", terrain: "arctic", faction: "Dungeon" },
      { name: "Derro", cr: "1/4", terrain: "arctic", faction: "Dungeon" },
      { name: "Starspawn Grue", cr: "1/4", terrain: "arctic", faction: "Dungeon" },
      { name: "Smoke Mephit", cr: "1/4", terrain: "arctic", faction: "Dungeon" },
      { name: "Abyssal Wretch", cr: "1/4", terrain: "arctic", faction: "Dungeon" },
      { name: "Apprentice Wizard", cr: "1/4", terrain: "arctic", faction: "Dungeon" },
      { name: "Drow", cr: "1/4", terrain: "arctic", faction: "Dungeon" },
    ...
    "1/2": [
      ...
      { name: "Orc", cr: "1/2", terrain: "arctic", faction: "Dungeon" },
      { name: "Gnoll", cr: "1/2", terrain: "arctic", faction: "Dungeon" },
      { name: "Gray Ooze", cr: "1/2", terrain: "arctic", faction: "Dungeon" },
      { name: "Vine Blight", cr: "1/2", terrain: "arctic", faction: "Dungeon" },
      { name: "Swarm of Rot Grubs", cr: "1/2", terrain: "arctic", faction: "Dungeon" },
      { name: "Shadow", cr: "1/2", terrain: "arctic", faction: "Dungeon" },
      { name: "Darkling", cr: "1/2", terrain: "arctic", faction: "Dungeon" },
      { name: "Ice Mephit", cr: "1/2", terrain: "arctic", faction: "Dungeon" },
      { name: "Anviwrought Raptor", cr: "1/2", terrain: "arctic", faction: "Dungeon" },
      { name: "Giant Wasp", cr: "1/2", terrain: "arctic", faction: "Dungeon" },
      { name: "Gazer", cr: "1/2", terrain: "arctic", faction: "Dungeon" },
      { name: "Cackler", cr: "1/2", terrain: "arctic", faction: "Dungeon" },
      { name: "Nupperibo", cr: "1/2", terrain: "arctic", faction: "Dungeon" },
      ...
      { name: "Arctic Worg", cr: "1/2", terrain: "arctic", faction: "Calanthian Frozen North" },
  ...
  { name: "Bugbear Thug", cr: "1", terrain: "arctic", faction: "Calanthian Frozen North" },
      ...
      { name: "Deep Dragon Wyrmling", cr: "1", terrain: "arctic", faction: "Dungeon" },
      { name: "Choker", cr: "1", terrain: "arctic", faction: "Dungeon" },
      { name: "Old Croaker", cr: "1", terrain: "arctic", faction: "Dungeon" },
      { name: "Scarecrow", cr: "1", terrain: "arctic", faction: "Dungeon" },
      { name: "Galvanice Weird", cr: "1", terrain: "arctic", faction: "Dungeon" },
      { name: "Nilbog", cr: "1", terrain: "arctic", faction: "Dungeon" },
      { name: "Vargouille", cr: "1", terrain: "arctic", faction: "Dungeon" },
      { name: "Garra", cr: "1", terrain: "arctic", faction: "Dungeon" },
      { name: "Xvart Warlock of Raxivort", cr: "1", terrain: "arctic", faction: "Dungeon" },
      { name: "Meazel", cr: "1", terrain: "arctic", faction: "Dungeon" },
      { name: "Jammer Leech", cr: "1", terrain: "arctic", faction: "Dungeon" },
      { name: "Ghoul", cr: "1", terrain: "arctic", faction: "Dungeon" },
    ...
    "2": [
      ...
      { name: "Aartuk Weedling", cr: "2", terrain: "arctic", faction: "Dungeon" },
      { name: "Gelatinous Cube", cr: "2", terrain: "arctic", faction: "Dungeon" },
      { name: "Mimic", cr: "2", terrain: "arctic", faction: "Dungeon" },
      { name: "Ogre Zombie", cr: "2", terrain: "arctic", faction: "Dungeon" },
      { name: "Carrion Crawler", cr: "2", terrain: "arctic", faction: "Dungeon" },
      { name: "Wererat", cr: "2", terrain: "arctic", faction: "Dungeon" },
      { name: "Ogre", cr: "2", terrain: "arctic", faction: "Dungeon" },
      { name: "Spined Devil", cr: "2", terrain: "arctic", faction: "Dungeon" },
      { name: "Meenlock", cr: "2", terrain: "arctic", faction: "Dungeon" },
      { name: "Gargoyle", cr: "2", terrain: "arctic", faction: "Dungeon" },
      { name: "White Dragon Wyrmling", cr: "2", terrain: "arctic", faction: "Dungeon" },
      { name: "Rug of Smothering", cr: "2", terrain: "arctic", faction: "Dungeon" },
      { name: "Cave Bear", cr: "2", terrain: "arctic", faction: "Dungeon" },
      { name: "Nothic", cr: "2", terrain: "arctic", faction: "Dungeon" },
      { name: "Swarm of Hoard Scarabs", cr: "2", terrain: "arctic", faction: "Dungeon" },
